...
* 📱 **Интерактивный сканер сети (Network Scanner)** — Встроенная утилита для проведения высокоскоростного ping-sweep сканирования подсети. Позволяет просматривать список всех активных устройств (IP, MAC, Hostname) и управлять доступом вручную (мгновенная блокировка/разблокировка конкретных устройств).
---
