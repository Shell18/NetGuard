...
```
+-----------------------------------------------------------------+
|  🛡️ NetGuard — ARP Spoof Detector & Active Defense              |
+-----------------------------------------------------------------+
|  [ Сетевой адаптер: Ethernet (Intel Gigabit) ]  [Старт Защиты]  |
|                                                                 |
|  +-----------------------------------------------------------+  |
|  | 🛡️ СТАТУС: Сеть под защитой                               |  |
|  | IP роутера: 192.168.1.1 | MAC эталон: 00:11:22:33:44:55   |  |
|  +-----------------------------------------------------------+  |
|                                                                 |
|  Таблица устройств в сети:                                      |
|  +-----------------------------------------------------------+  |
|  | IP-адрес       | MAC-адрес         | Статус     | Действие|  |
|  +-----------------------------------------------------------+  |
|  | 192.168.1.1    | 00:11:22:33:44:55 | Шлюз       | ---     |  |
|  | 192.168.1.102  | 00:aa:bb:cc:dd:ee | Активен    | [ БАН ] |  |
|  +-----------------------------------------------------------+  |
|                                                                 |
|  Лог событий (Real-time):                                       |
|  [14:23:01] [*] Определение IP-адреса шлюза...                  |
|  [14:23:02] [+] Шлюз обнаружен: 192.168.1.1                     |
|  [14:23:02] [+] Успешно получен эталонный MAC: 00:11:22:33:44:55|
|                                                                 |
+-----------------------------------------------------------------+
```
*(Скриншот реального интерфейса будет доступен после запуска приложения)*
